...
static struct l2_level l2_freq_tbl_8960_kraitv2[] = {
	...
	[21] = { { 1512000, HFPLL, 1, 0, 0x36 }, 1150000, 1150000, 7 },
	[22] = { { 1674000, HFPLL, 1, 0, 0x38 }, 1150000, 1150000, 7 },
};
...
static struct acpu_level acpu_freq_tbl_8960_kraitv2_slow[] = {
	...
	{ 1, {  1890000, HFPLL, 1, 0, 0x40 }, L2(21), 1350000 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_8960_kraitv2_nom[] = {
	...
	{ 1, {  1674000, HFPLL, 1, 0, 0x3A }, L2(20), 1200000 },
	...
	//{ 1, {  2050000, HFPLL, 1, 0, 0x44 }, L2(21), 1325000 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_8960_kraitv2_fast[] = {
	...
	//{ 1, {  2160000, HFPLL, 1, 0, 0x44 }, L2(21), 1300000 },
	//{ 1, {  2250000, HFPLL, 1, 0, 0x46 }, L2(21), 1300000 },
	{ 0, { 0 } }
};
#else
static struct acpu_level acpu_freq_tbl_8960_kraitv2_nom[] = {
