...
static struct l2_level l2_freq_tbl_8960_kraitv2[] = {
	...
	[20] = { { 1458000, HFPLL, 1, 0, 0x34 }, 1150000, 1150000, 6 },
	[21] = { { 1512000, HFPLL, 1, 0, 0x36 }, 1200000, 1200000, 7 },
	[22] = { { 1674000, HFPLL, 1, 0, 0x38 }, 1200000, 1200000, 7 },
};
...
static struct acpu_level acpu_freq_tbl_8960_kraitv2_nom[] = {
	...
	{ 0, {  1188000, HFPLL, 1, 0, 0x2C }, L2(17), 1125000 },
	{ 1, {  1242000, HFPLL, 1, 0, 0x2E }, L2(18), 1125000 },
	...
	{ 1, {  2050000, HFPLL, 1, 0, 0x44 }, L2(22), 1350000 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_8960_kraitv2_fast[] = {
	...
	{ 0, {  1404000, HFPLL, 1, 0, 0x34 }, L2(20), 1125000 },
	...
	{ 1, {  2160000, HFPLL, 1, 0, 0x44 }, L2(22), 1350000 },
	{ 1, {  2250000, HFPLL, 1, 0, 0x46 }, L2(22), 1350000 },
	{ 0, { 0 } }
};
#else
static struct acpu_level acpu_freq_tbl_8960_kraitv2_nom[] = {
