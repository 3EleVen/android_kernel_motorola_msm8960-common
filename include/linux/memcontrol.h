...
extern void mem_cgroup_out_of_memory(struct mem_cgroup *memcg, gfp_t gfp_mask,int order);
...
static inline int mm_match_cgroup(struct mm_struct *mm, struct mem_cgroup *memcg)
{
	return 1;
}
...
mem_cgroup_prepare_migration(struct page *page, struct page *newpage,
	struct mem_cgroup **memcg, gfp_t gfp_mask)
{
	return 0;
}
